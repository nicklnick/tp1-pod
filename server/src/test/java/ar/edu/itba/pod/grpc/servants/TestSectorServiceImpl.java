...
public class TestSectorServiceImpl {
    ...
    public void testGetRangesBySectorIncludeAssignedRanges(){
        ...
        Assertions.assertEquals(ranges.get(2).getEnd(),15);

        Assertions.assertEquals(ranges.get(3).getStart(),16);
        Assertions.assertEquals(ranges.get(3).getEnd(),20);
        Assertions.assertEquals(ranges.get(3).getClass(),ContiguousRange.class);
        ...
        sectorService.assignCounterRangeToAirline(sectorA,aerolineas,flightsAerolineas,10);
        ranges = sectorService.getRangesBySector(sectorA,1,20);
        Assertions.assertEquals(ranges.size(),4);
